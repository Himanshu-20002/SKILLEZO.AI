/**
 * SKILLEZO RESUME STUDIO — PHASE 7 BUILDER TYPES
 * Builder configuration owns presentation and styling only.
 * ResumeDocument remains the canonical source of resume content.
 */
