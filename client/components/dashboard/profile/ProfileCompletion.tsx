  ...
  return (
    <div className="p-6 sm:p-7 rounded-3xl bg-[#0c1427]/90 dark:bg-slate-900/90 border border-slate-800 text-white backdrop-blur-xl space-y-5 shadow-sm dark:shadow-md relative overflow-hidden">
      ...
      <div className="relative z-10 space-y-1">
        <h3 className="text-base font-bold text-white tracking-tight">Profile Completion</h3>
        <p className="text-xs text-slate-400">Complete steps to unlock enterprise recruiter visibility</p>
      </div>
      ...
      <div className="space-y-2 relative z-10">
        <div className="flex justify-between items-center text-xs font-semibold">
          ...
          <span className="text-[#00D9C0] font-black text-sm">{displayScore}%</span>
        </div>
