...
export const ApplicantCard: React.FC<ApplicantCardProps> = ({
  ...
  return (
    <div
      ...
      className="p-4 rounded-2xl bg-white dark:bg-[#111736] border border-slate-200/90 dark:border-slate-800 hover:border-[#3D5AFE]/50 dark:hover:border-[#3D5AFE]/50 transition-all duration-200 shadow-xs hover:shadow-md cursor-pointer space-y-3 group backdrop-blur-md"
    >
      {/* Top Row: Candidate Name & Employability Score */}
      ...
      {/* Footer Meta: Applied date & Verified status */}
