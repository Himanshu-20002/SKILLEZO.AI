  ...
  return (
    <div>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 rounded-xl border border-white/10 py-3 text-white hover:bg-white/5 cursor-pointer disabled:opacity-60 transition-colors"
      >
        {isLoadingGoogle ? (
          <>
