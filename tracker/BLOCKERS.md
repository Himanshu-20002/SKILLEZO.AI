...
| :-: | :---: | :---: | :--- | :---: | :--- |
| **BLK-001** | 31-Aug-2026 | 🔴 P0 | Local Next.js rewrite proxy defaults to remote Railway URL | Dev 2 | Added `BACKEND_INTERNAL_URL=http://localhost:5000` to `client/.env.local`. |
